...
export default function QuoteTypeSelector(props) {
  ...
  return (
    <div className="quoteTypeSelector">
        ...
        <select className='quoteTypeSelector-DropDown' name='typeSelector' id={uniqueId} onChange={(e) => handleQuoteTypeSelection(e.target.value)} /*</div>onChange={(e) => handleQuoteTypeChange(e.target.value)}*/>
